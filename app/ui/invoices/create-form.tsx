...
//     if (!event.currentTarget.customerId.value) {
//       setCustomerError('Please choose a customer');
//       formIsValid = false;
//     } else {
//       setCustomerError('');
//     }
...
//     if (!event.currentTarget.status.value) {
//       setStatusError('Please set the invoice status');
//       formIsValid = false;
//     } else {
//       setStatusError('');
//     }
